...
export default class Sweet extends Component {
    ...
    initialState = {
        id:'', categoryName:'', productName:'', rate:'', offerName:'', offerRate:'',image:''
    };
    ...
    sweetList = () => {
        return this.props.history.push("/SweetActions");
    };

    render() {
        const {categoryName, productName, rate, offerName, offerRate,image} = this.state;
                            ...
                            <Form.Row>
                                ...
                                <Form.Group as={Col} controlId="formGridPrice">
                                    ...
                                    <Form.Control required autoComplete="off"
                                        ...
                                        value={image} onChange={this.sweetChange}
                                        className={"bg-dark text-white"}
