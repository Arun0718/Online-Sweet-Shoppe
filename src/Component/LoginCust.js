...
class Login extends React.Component{
    ...
    newUser = () =>{
        this.props.history.push('/signupCust');
    }
    ...
    render()
    {
        return(
            ...
            <form className="form1">
                ...
                <hr></hr>
                <button type="Signup" className="btn btn-success ml-3" onClick={this.newUser}>Sign Up</button>
                <br></br>
                 {/* <div className="ml-auto mt-2">
                <Link to="/" ><u>Forget Password?</u></Link>
                </div>  */}
            </form>
            </div>
            </div>
