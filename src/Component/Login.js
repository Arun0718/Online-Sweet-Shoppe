                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        ...
                                        <FormControl required autoComplete="off" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" value={email} onChange={this.credentialChange}
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        ...
                                        <FormControl required autoComplete="off" type="password" pattern="[a-z0-9._%+-]" name="password" value={password} onChange={this.credentialChange}
